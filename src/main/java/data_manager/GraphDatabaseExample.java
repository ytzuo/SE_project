...
public class GraphDatabaseExample {
    ...
    public void insertKnowledgeData() {
        try (Transaction tx = graphDb.beginTx()) {
            ...
            insertKnowledgeWithPoints(tx, chapterNode, "2.2 瀑布模型", new String[]{
                    ...
                    "选择1: 在瀑布模型中，哪一个特性决定了它的开发流程是“顺序进行”的？\nA. 文档驱动   B. 客户参与有限   C. 阶段间的不可逆性      答案:C",
                    "选择2: 瀑布模型的阶段有: 需求分析、系统设计、(  ) 、测试、部署、维护\nA. 交付,客户    B. 论证可行性   C.需求修改    D.编码实现   答案:D",
            ...
            insertKnowledgeWithPoints(tx, chapterNode, "2.4 原型模型", new String[]{
                    ...
                    "选择1: 原型模型以什么为核心(  )?\nA. 客户    B. 用例    C. 文档    D.产出    答案:A",
                    "选择2: 原型模型能否用于客户需求不明确的场景? (   )\nA. 不能    B. 能       答案:B",
                    "选择3: 原型的特点有(   )\nA. 不可交互   B.较为简单   C. 成本高   答案: B",
            ...
            insertKnowledgeWithPoints(tx, chapterNode, "2.6 喷泉模型", new String[]{
                    ...
                    "选择1: 喷泉模型是(  )模型\nA. 非线性      B. 线性    C. 高效   D. 易实现  答案:A",
                    "选择2: 喷泉模型中哪个阶段最容易在后续进行修改?\nA. 测试    B. 概念化    C. 需求收集    D. 实现   答案:B",
            ...
            insertKnowledgeWithPoints(tx, chapterNode, "2.7 统一过程模型 (RUP)", new String[]{
                    ...
                    "选择1: 统一过程模型 (RUP) 是一种(  )开发过程\nA. 迭代式   B. 瀑布式    C. 原型式   答案:A",
                    "选择2: 统一过程模型的核心原则是什么？\nA. 计划详细   B. 文档详尽    C. 迭代开发   答案:C",
            ...
            insertKnowledgeWithPoints(tx, chapterNode, "2.8 敏捷开发模型", new String[]{
                    ...
                    "选择1: 敏捷开发的核心原则是(  )\nA. 延迟交付    B. 灵活应变   C. 文档驱动   答案:B",
                    "选择2: 敏捷开发强调(  )的参与\nA. 客户   B. 开发团队  C. 规划人员   答案:A",
    ...
    private void insertKnowledgeWithPoints(Transaction tx, Node chapterNode, String knowledgeName, String[] knowledgePoints, String[] exercises) {
        // 插入二级知识点节点
        ...
        for (String exercise : exercises) {
            Node exerciseNode = GraphDatabaseHelper.insertNode(tx, "exercise", "content", exercise);
            GraphDatabaseHelper.insertRelationship(tx, exercisesNode, exerciseNode, "HAS_EXERCISE");
        }
    }
