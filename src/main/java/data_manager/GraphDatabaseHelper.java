...
public class GraphDatabaseHelper {
    ...
    public static Node insertNode(GraphDatabaseService graphDb, String label, String propertyKey, String propertyValue) {
    ...
    public static Relationship insertRelationship(GraphDatabaseService graphDb, Node startNode, Node endNode, String relationshipType) {
        try (Transaction tx = graphDb.beginTx()) {
            // 创建一个关系
    ...
    public static void insertMultipleNodes(GraphDatabaseService graphDb, String label, String[] propertyKeys, String[] propertyValues) {
        try (Transaction tx = graphDb.beginTx()) {
